...
def update(probabilities, one_gene, two_genes, have_trait, p):
    ...
    """
    # print(f"update: probabilities = {probabilities} one_gene = {one_gene}, two_genes = {two_genes}, have_trait = {have_trait}, p = {p}")
...
def normalize(probabilities):
    ...
    """
    print(f"normalize:  probabilities = {probabilities}")
    for person in probabilities:
        # normalize gene
        ...
        for i in probabilities[person]["trait"]:
            probabilities[person]["trait"][i] /= total
